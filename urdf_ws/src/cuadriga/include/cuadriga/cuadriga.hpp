...
{ 
    public:
        ...
        void process_trayectoria_archivo(const cuadriga_interfaces::msg::GPXPath::SharedPtr msg);
        //void process_trayectoria_planificacion(const std_msgs::msg::Float32MultiArray::SharedPtr msg);
        std::array<float,2> computeLookaheadArc(float x, float y, const std::vector<std::array<float,2>>& path, float Ld, bool& atEnd);

        //PUBLICADORES
        //=============================================
        rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr pub_cmd_;
        rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr pub2_;
        rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr pub3_;
    ...
    std_msgs::msg::Float32MultiArray objetivo_grafica;
